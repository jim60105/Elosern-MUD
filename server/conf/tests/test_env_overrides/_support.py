...
VALID_OVERRIDES: list[tuple[str, str, str, str]] = [
    ...
    ("ART_TRANSLATE_DOWNLOAD_ENABLED", "ART_TRANSLATE_DOWNLOAD_ENABLED", "off", "False"),
    ("ART_TRANSLATE_DOWNLOAD_ENABLED", "ART_TRANSLATE_DOWNLOAD_ENABLED", "on", "True"),
...
INVALID_VALUES: list[tuple[str, str, str]] = [
    ...
    ("ART_TRANSLATE_DOWNLOAD_ENABLED", "maybe", "1/true/yes/on/0/false/no/off"),
