...
ROWS: tuple[PlaceDefinition, ...] = (
    ...
    PlaceDefinition(
        ...
        room_desc_zh=(
            ...
            "事名字的聲調跟喊祝禱時完全一樣。敬拜、事工、買賣在同一棟屋簷下、毫不避人，光明教會就是這樣過日子的，這整個大陸都知道，就像大家都知道"
            "酒館賣酒。"
        ),
        exterior_xy=(4, 4),  # 大神殿前
        doorway_key_zh="聖所",
    ...
    PlaceDefinition(
        ...
        room_desc_zh=(
            ...
            "桌上。街區的巡邏按整點輪過這裡。牆上沒有任何一張是命令，屋裡也沒有任何一樣東西是阻擋，當初蓋這駐所的人把地面從門到桌留成空的，像一戶"
            "沒有訪客的人家把客廳的門敞著。"
        ),
    ...
    PlaceDefinition(
        ...
        room_desc_zh=(
            ...
            "這座城市懂得的每一條魔法階級階梯與八元素的知識，都是在像這樣某個地方被教出來的，而王國的這一間，正是薇歐蕾特·阿爾托利亞從前坐過的教"
            "室。"
        ),
        exterior_xy=(5, 5),  # 學院前
