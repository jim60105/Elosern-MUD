...
ROWS: tuple[PlaceDefinition, ...] = (
    PlaceDefinition(
        ...
        room_desc_zh=(
            "光明神殿的光比屋子先到：長窗沿中殿一路開到屋頂，晨光從窗格斜斜落"
            "下來，亮得幾乎可以用手捧住。長椅對著墊高的臺，主祭在那裡誦讀、祝禱、"
            "回答提問；空氣裡留著一點今日焚香的氣息。近處的牆邊，中殿沒有任何隔斷"
            "或簾幔，直接敞進聖所自己的大廳——教會行愛之工的地方，從長椅上就看得見"
            "那裡的商品櫃。祝禱、事工與買賣是同一份信仰的三座櫃檯，並排站在同一片"
            "光裡；這座城市裡沒有人會覺得提起它們其中任何一樣時該壓低聲音。"
        ),
    ...
    PlaceDefinition(
        ...
        room_name_zh="聖潔王都聖所",
        room_desc_zh=(
            "聖所開在中殿旁邊，同一個屋簷、同一排窗：暖的光、洗淨的亞麻布、"
            "臉盆裡備好的溫水，一面牆邊是一張和城裡任何店面沒有兩樣的商品櫃——"
            "禮儀與安養器物的層架、玻璃瓶、軟布祭袍摺得整整齊齊，標價與補貨的方式"
            "跟雜貨店一模一樣。執事們手臂下夾著賬簿，在櫃檯與廊底客房之間來回，"
            "喊執事名字的聲調跟喊祝禱時完全一樣。敬拜、事工、買賣在同一棟屋簷下、"
            "毫不避人：光明教會就是這樣持家的，這整個大陸都知道，就像大家都知道"
            "酒館賣酒。"
        ),
        exterior_xy=(4, 4),  # 大神殿前
        doorway_key_zh="聖所",
    ...
    PlaceDefinition(
        ...
        room_name_zh="聖潔王都王宮",
        room_desc_zh=(
            "聖潔王都的王座通道在自己屋簷下升起：磨亮的石材正是這座王都立足"
            "的崖壁顏色，立柱之間的寬度夠得過一支儀仗，最遠端是三級臺的矮臺，"
            "王椅在臺後俯瞰整座大殿的全長。它宏偉、潔淨，而且正在等待——門口沒有"
            "衛兵，地上沒有跪求的人，沒有任何聲音在大理石上迴盪。這間屋子遲早要"
            "裝進的東西、一座王宮該有的每個故事，都還沒有被寫出來，大殿也懶得假裝"
            "不是這樣。沿著它走完一趟的人會聽見的唯一聲音是自己的腳步——那才是"
            "這座城市頭上這頂王冠最忠實的描述。"
        ),
    ...
    PlaceDefinition(
        ...
        room_desc_zh=(
            "聖潔王都的貴族區衛所是一間縱長的屋子，堆著盾牌、疊著斗篷，兩頭各"
            "一座火盆，門邊一張登記桌——若還有什麼人到訪需要登記，就會被寫在這張"
            "桌上。街區的巡邏按整點輪過這裡。牆上沒有任何一張是命令，屋裡也沒有"
            "任何一樣東西是阻擋：當初蓋這駐所的人把地面從門到桌留成空的，就像一戶"
            "沒有訪客的人家，把客廳的門就這樣敞著。"
        ),
    ...
    PlaceDefinition(
        ...
        room_name_zh="聖潔王都校場",
        room_desc_zh=(
            "聖潔王都的校場是上城牆下一片耙平的泥地：練習樁一排排立著，圍繩的"
            "握處磨得發白，一條長凳，是那種一整個上午的套路練下來會讓人一身汗的"
            "長凳。王都的徵兵在白天於此操練，公會到傍晚才來用屬於它的時段，樁上的"
            "痕跡來自一百雙不同的手。場子裡沒有任何東西會自己磨快一刀或評定一階——"
            "它是這座城市來做「任何地面都肯承接的那種功課」的地方，只因為在這裡，"
            "每個人都看得見標準在哪裡。"
        ),
        exterior_xy=(2, 4),  # 校場外
        doorway_key_zh="校場",
    ...
    PlaceDefinition(
        ...
        room_desc_zh=(
            "聖潔王都的學院把講課收在同一個屋簷下：一間長廳，階梯式的長椅面對著"
            "示範場，無論幾點都燈光明亮到能讀書，廳旁是一間書庫，王都藏的階級課本"
            "照學生攀登的順序上架。學生在門外的階梯上爭論，裡面的講師回答問題的方式"
            "正是一所學校該有的樣子——一路答到底。院長的書桌正對著示範場；這座城市"
            "懂得的每一條魔法階級階梯與八元素的知識，都是在像這樣某個地方被教出來的，"
            "而王國的這一間，正是薇歐蕾特·阿爾托利亞從前坐過的教室。"
        ),
        exterior_xy=(5, 5),  # 學院前
