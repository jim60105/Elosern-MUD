...
ROWS: tuple[PlaceDefinition, ...] = (
    PlaceDefinition(
        ...
        room_desc_zh=(
            ...
            "有什麼東西是為了讓誰買而分類的。長老的家當都是被記得的東西，村莊自己的歷史完完整整留著，沒有一樣拿出來等著賺陌生人的錢。"
        ),
    ...
    PlaceDefinition(
        ...
        room_name_zh="泰莉爾的家",
        room_desc_zh=(
            "練刀場邊的一戶人家，屋裡那片騰空的空間掃得乾淨，為赤腳練刀的人留的。木刀在門邊排成一排，刀柄被許多手握得發白；對面擱著坐墊與水壺，為"
            "每一次練習都得還的休息留的。屋裡沒有一樣東西在賣，村子刀術導師的家教人的方式，和她的場子一直以來一樣，靠練習者自己的重複。"
        ),
        exterior_xy=(2, 1),  # 練刀場
