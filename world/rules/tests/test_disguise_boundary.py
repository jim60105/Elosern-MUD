...
# authors a preset/import declaration. The placement record
# (``disguise_placed_by_cast``) is written by the same classified runtime
# module beside the display mapping (divine-veil-cast-path). Snapshot/restore
    ...
    def test_forbidden_rules_modules_do_not_read_disguise_layer(self):
        ...
        for relative_path in FORBIDDEN_MODULES:
            ...
            if path.exists():
                ...
                self.assertNotIn("disguise_placed_by_cast", source, relative_path)
