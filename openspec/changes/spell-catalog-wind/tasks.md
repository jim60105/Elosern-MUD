...
- [ ] 2.1 Add 8 new `_skill(...)` entries to `SKILL_REGISTRY` in `world/skills/registry.py` for: `gale_step`, `tornado_blade`, `storm_domain`, `gale_dance_strike`, `heavens_wrath_storm`, `haste_domain`, `vacuum_severance`, `sky_tempest`.
