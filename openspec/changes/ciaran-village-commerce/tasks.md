...
- [ ] 1.1 Add the `village_ciaran` row to `SETTLEMENT_REGISTRY` with the elven-village archetype
  and the village's zcoord, at par price scale.
- [ ] 1.2 Add four elven-craft assortments — blades, garments, fare, sundries — to
...
- [ ] 2.1 Add `world/lore/settlements/places_ciaran.py` with 海莉爾的家 off 練刀場, host
  海莉爾·斯塔爾法爾 / `暗影谷村鑄刃者` / elf / ciaran / female, selling the blades assortment.
- [ ] 2.2 Add 拉瑞內斯的家 off 溪畔小徑 (拉瑞內斯·妮特布倫 / `暗影谷村花饌好手`, fare),
  瓦爾溫的家 off 村北古樹下 (瓦爾溫·斯蒂爾瓦特爾 / `暗影谷村蒐羅者`, sundries), and
  維特希爾的家 off 織房坡 (維特希爾·威爾德布瑞亞爾 / `暗影谷村織衣者`, garments) — all
  elf / ciaran / female.
- [ ] 2.3 Write interior names and descriptions that read as dwellings: no counter, sign, shopfront
  or trade vocabulary anywhere in the text, and no 老闆/店主 in any title.
- [ ] 2.4 Add the four shop rows with hours to `commerce.yaml` and verify all four interiors, their
...
- [ ] 3.1 Add `elven_spider_silk` to the village collector's sundries assortment at an everyday
...
- [ ] 3.2 Confirm the capital references no elven assortment, and verify both offers resolve to
...
- [ ] 4.1 Verify a purchase from a village host settles wallet, inventory, stock, acquisition
...
- [ ] 4.2 Verify the trade and shop-command paths contain no settlement-archetype branch or village
  special case.

## 5. Handoff

- [ ] 5.1 Run `uv run --locked python -m tools.test_data_lint check`, register any new test module
