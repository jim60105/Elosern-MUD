...
- [ ] 2.1 Add 10 new `_skill(...)` entries to `SKILL_REGISTRY` in `world/skills/registry.py` for: `heal`, `light_arrow`, `purify`, `mass_heal`, `advanced_heal`, `holy_shield`, `holy_radiance`, `revival_light`, `goddess_blessing`, `heavens_judgment_light`.
