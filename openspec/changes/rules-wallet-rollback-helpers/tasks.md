...
- [x] 2.1 In `world/rules/clock.py`, generalize `_restore_registry_attribute` to accept a
...
- [x] 2.2 In `world/rules/cast_settlement.py`, replace the body of
