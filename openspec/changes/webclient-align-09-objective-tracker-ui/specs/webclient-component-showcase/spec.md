# Delta spec: webclient-component-showcase (webclient-align-09-objective-tracker-ui)

This delta MODIFIES the deferred-surface requirement as modified by
`webclient-align-05-party-hud`; apply after that change (both land in the same roadmap wave —
if they merge in the other order, rebase this block onto whichever version of the requirement
text is current).
...
requirement), and its completeness and absence-when-`null` behaviour is governed by
