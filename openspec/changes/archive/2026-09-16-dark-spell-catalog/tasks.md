...
```sh
uv run --locked evennia test --settings test_settings.py --keepdb world.skills.tests.test_spell_catalogs world.skills.tests.test_cost_tiers world.rules.tests.test_skill_lineage world.rules.tests.test_dark_curse_erosion world.rules.tests.test_buffs world.rules.tests.test_combat_modifiers world.rules.tests.test_status_display
