# Delta: movement-settlement-atomicity

## RENAMED Requirements

- FROM: `### Requirement: Movement settles relocation, clock cost, map knowledge, companion following, and onboarding as one coherent transaction`
- TO: `### Requirement: Movement settles relocation, clock cost, map knowledge, and companion following as one coherent transaction`
