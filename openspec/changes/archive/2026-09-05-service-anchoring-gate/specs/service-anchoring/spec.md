# Delta spec: service-anchoring (service-anchoring-gate)

New capability: the authored binding axis, its persistence on components, and the single
availability resolver every service gate consults.
