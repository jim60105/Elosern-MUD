...
SHALL currently be a verified no-op (no party system exists) exposed as a named function so the
future party change wires it without touching the writer. The hook SHALL be deterministic and
side-effect free today.
