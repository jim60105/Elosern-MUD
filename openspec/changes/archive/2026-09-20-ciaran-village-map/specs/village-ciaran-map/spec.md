...
`zcoord="village_ciaran"` describing a six-node connected tree: a single
entrance node, a central plaza, and four further exterior nodes reflecting
...
- **THEN** the village's six rooms exist in its own coordinate space, are
