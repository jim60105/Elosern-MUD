...
- **THEN** the row shows its display name with its `kind` as the sub-line and renders no statistics line and no portrait, because the exploration payload carries neither
