...
- [x] 6.3 Migrate `world/prompts/tests/test_degrade.py` (tier A): swap literals for kit constants/fixtures, restate assertions as behavior, run the focused label for this file only
- [x] 6.4 Migrate `world/prompts/tests/test_loader.py` (tier B): swap literals for kit constants/fixtures, restate assertions as behavior, run the focused label for this file only
- [x] 6.5 Migrate `world/prompts/tests/test_verbatim_shipment.py` (tier A): swap literals for kit constants/fixtures, restate assertions as behavior, run the focused label for this file only
