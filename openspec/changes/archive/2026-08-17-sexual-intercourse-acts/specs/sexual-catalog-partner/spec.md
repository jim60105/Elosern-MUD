# sexual-catalog-partner Delta Specification

## RENAMED Requirements

- FROM: `### Requirement: Fourteen Tier 1-4 partner acts are registered, gated by duo_act_count and/or group_act_count and/or climax_count thresholds`
- TO: `### Requirement: Sixteen Tier 1-4 partner acts are registered, gated by duo_act_count and/or group_act_count and/or climax_count thresholds`
- FROM: `### Requirement: partner_anal_sex and partner_mutual_masturbation are the two Tier 3 acts, trading off at baseline sensitivity`
- TO: `### Requirement: The four Tier 3 acts trade off at baseline sensitivity`
- FROM: `### Requirement: All fourteen acts declare resistible=True`
- TO: `### Requirement: All sixteen acts declare resistible=True`
- FROM: `### Requirement: None of this change's fourteen keys collide with any previously-registered act key`
- TO: `### Requirement: None of this change's sixteen keys collide with any previously-registered act key`
...
and `partner_deep_vaginal_sex` SHALL declare `actor_counters=("duo_act_count",)` and
`participant_counters=("duo_act_count",)`. Each of `partner_group_caress`, `partner_group_orgy`,
and `partner_group_service` SHALL declare `actor_counters=("group_act_count",)` and
`participant_counters=("group_act_count",)`.
