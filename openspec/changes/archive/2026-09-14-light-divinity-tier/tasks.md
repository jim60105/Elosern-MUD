...
- [x] 1.2 Extend the common cost tier with the documented sixth row and optional label-only level band; follow LSP references and verify consumers do not infer a new cast gate.
- [x] 1.3 Test matching-column precedence with synthetic SINGLE/AREA 180, new endpoints and out-of-all-band rejection; verify the existing opposite-column cases retain their outcomes.
