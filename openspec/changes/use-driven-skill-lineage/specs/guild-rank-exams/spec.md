...
kill rewards: no kill loot, no DEFEAT quest progress, and no protected-entity failure; and no growth of any kind: every examination resolution runs under the `nonlethal` marker, so lineage practice accrual is skipped for every skill used. MP/SP costs and
