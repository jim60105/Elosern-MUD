...
- No behavior change beyond the vocabulary member and the new cross-language check: no new adjustment field, no new budget column, no settlement path touched.
- **No new game-data contract test.** The vocabulary alignment check compares two vocabularies, not item content, and the wearables' numbers stay gated by the rulebook loader.
