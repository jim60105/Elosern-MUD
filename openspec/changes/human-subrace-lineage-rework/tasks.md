...
- [ ] 1.1 Rewrite the five human `Subrace` entries in `world/lore/races.py`: rename keys
...
- [ ] 1.2 Rework `world/lore/starting_kits.py:32-36` to the §3.4 table: `human_coastal` →
...
- [ ] 1.3 Update `world/lore/player_presets.py:278`: 艾莉莎 (`elysa_snow`) subrace
...
- [ ] 3.1 Update `world/imports/examples/example_character.json:10` (`subrace`) and
...
- [ ] 4.1 Apply this change's delta to `openspec/specs/lore-registries/spec.md` (the
      ...
      the requirement.
- [ ] 4.2 Update `docs/lore/overview.md:39` and
...
- [ ] 4.3 Update `tmp/story_settings/world_info.md`: line 42, the human subrace list at
...
- [ ] 5.1 Run the canonical Evennia runner —
...
- [ ] 5.2 Run `uv run --locked python -m tools.spec_traceability check` and
      ...
      update.
- [ ] 5.3 Re-run the DB rebuild / `world.lore.sync.sync_all` path used by the test settings
