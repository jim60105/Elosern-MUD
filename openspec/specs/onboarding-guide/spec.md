...
Onboard new players through a scripted arrival at 聖潔王都's South Gate, guided by the South Gate
guard toward the adventurers' guild, with deterministic state owned by the rules core.
