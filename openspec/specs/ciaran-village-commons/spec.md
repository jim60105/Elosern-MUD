# ciaran-village-commons Specification

## Purpose
Give 暗影谷村 the three shared spaces the lore document names but the village never had — a
communal shelter, the sword instructor's dwelling and the elder's dwelling — and pin the
cultural rule that makes them shared rather than institutional: no counter, no authority,
no gate.
