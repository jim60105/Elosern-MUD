# quest-failure-conditions Specification

## Purpose
Deterministic quest failure: world-clock deadline expiry through the existing ordered settlement stage,
and key-entity defeat failure for bound protected entities, each atomic with the originating transition.
