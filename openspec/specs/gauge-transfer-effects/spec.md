# gauge-transfer-effects Specification

## Purpose
Define the typed gauge_transfer effect family with closed gauge set {mp, hp}, validated magnitude modes, canonical-writer routing, caster drain-recovery share, marker-bonus restores, regen-lock marker scaling, and target-state audience gating.
