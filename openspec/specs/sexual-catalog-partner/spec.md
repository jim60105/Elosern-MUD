...
Register the fourteen counter-gated 關係線 acts across four tiers, filling the partner line from
its two seed acts to sixteen. Tier 1 opens at `duo_act_count >= 5`, Tier 2 at
...
交合 and 深度交合 (vaginal intercourse and the D-12 opposite-sex `virgin`-breaking branch) are
deferred pending an engine capability this change does not build.
