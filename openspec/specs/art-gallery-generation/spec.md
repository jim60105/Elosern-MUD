...
operator surface can report it. Nothing in the resolution of an existing card SHALL depend on any
generation having succeeded, so a fully offline deployment stays playable.
