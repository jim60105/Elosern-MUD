...
// wizard for the committed `creation` v1 panel — preset pick, custom form
// (adult gate on BOTH the age and apparent_age fields, design D1), the
// concept branch, and the server-persisted wizard draft. Every action emits
// the exact `creation.*` OOB envelope; the offline showcase stays truthful:
// no invented preset fields, budgets, or affinity values.
...
export const ConceptDraft = {
  render: renderOverlay,
  args: { creation: CREATION_PANEL_CONCEPT_DRAFT_SAMPLE },
};
