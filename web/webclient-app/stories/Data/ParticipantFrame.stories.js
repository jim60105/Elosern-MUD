...
export const PartyAndFoes = {
  ...
  args: {
    participants: [
      { identity: 1, token: "P1", display_name: "林楓", team: "allies", state: "active", hp_current: 80, hp_maximum: 100, portrait_ref: "p1" },
...
export const FledKnockedOutDefeated = {
  ...
  args: {
    participants: [
      ...
      { identity: 1, token: "P1", display_name: "林楓", team: "allies", state: "knocked_out", hp_current: 0, hp_maximum: 100, portrait_ref: "p1" },
...
export const NullPortraitRef = {
  ...
  args: {
    participants: [
      { identity: 1, token: "P1", display_name: "林楓", team: "allies", state: "active", hp_current: 100, hp_maximum: 100, portrait_ref: null },
    ],
    artPanel: ART_PANEL,
  },
};
